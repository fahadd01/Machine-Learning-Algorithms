# -*- coding: utf-8 -*-
"""20100149_ML_A5.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19eRt4qPMP6G1Nq_2L4-6zCc0sZdklltP
...
#fit your model here
plots_data = model.fit(trainX, trainY, steps_per_epoch = math.floor(len(trainX)/batch_size), validation_split=0.1, epochs = epochs)
#10 percent validation data to keep consistency with part 1 i.e. 54000/6000
...
#Plot Loss
plt.plot(plots_data.history['loss'], label = 'Training Loss')
plt.plot(plots_data.history['val_loss'], label = 'Validation Loss')
plt.xlabel('epochs')
plt.ylabel('loss')
plt.title('LOSS')
plt.legend()
...
#Plot Accuracy
plt.plot(plots_data.history['accuracy'], label = 'Training Accuracy')
plt.plot(plots_data.history['val_accuracy'], label = 'Validation Accuracy')
plt.xlabel('epochs')
plt.ylabel('accuracy')
plt.title('ACCURACY')
plt.legend()
